...
$items = [
    '<div id="item_1" onclick="location.href=\'../\';" class="col-lg-3 col-xs-3">
    ...
    '<div id="item_2" class="col-lg-3 col-xs-3">
    ...
    '<div id="item_3" class="col-lg-3 col-xs-3">
    ...
    '<div id="item_4" class="col-lg-3 col-xs-3">
    ...
    '<div id="item_5" class="col-lg-3 col-xs-3">
    ...
    '<div id="item_6" class="col-lg-3 col-xs-3">
    ...
    '<div id="item_7" class="col-lg-6 col-xs-6">
    ...
    '<div id="item_8" class="col-lg-3 col-xs-3">
    ...
    '<div id="item_9" class="col-lg-3 col-xs-3">
    ...
    '<div id="item_10" class="col-lg-6 col-xs-6">
...
<div class="container-fluid dynamicTile">
    <div class="row">
        ...
        $result = $db->getRow("SELECT sort FROM sortable WHERE id = 1");
